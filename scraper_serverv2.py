...
class MultiThreadScraper:
    ...
    def run_scraper(self):
        while True and len(self.scraped_pages)<1000: 
            try:
...
if __name__ == '__main__':
    Query = input("QUERY:")
    s = MultiThreadScraper("https://www.amazon.in/",Query)
    #s = MultiThreadScraper("http://news.bbc.co.uk/2/hi/health/2760843.stm",Query)
    start = time.time()
    s.run_scraper()
